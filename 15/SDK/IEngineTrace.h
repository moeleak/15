...
public:
	...
	virtual bool ShouldHitCBaseEntity(IHandleEntity *pServerCBaseEntity, int contentsMask)
	{
        bool IsPlayer = g_pClientDll->GetAllClasses()->ClassID == EClassIds::CCSPlayer;
