...
public:
    ...
    {
        return Utils::CallVFunc<103, void>(this, x, y, radius, segments);
    }
	...
	{
		return Utils::CallVFunc<123, void>(this, x0, y0, x1, y1, alpha0, alpha1, bHorizontal);
	}
};
...
public:
    ...
    {
        return Utils::CallVFunc<36, const char*, int>(this, iPanel);
    }
};
